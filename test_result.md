...
agent_communication:
  ...
  - agent: "main"
    message: "MAJOR CLEANUP AND NEW FEATURES: 1) Removed entire tournament bracket system from backend (models, API endpoints) and frontend (components, pages, routes). 2) Added 'End Game' button to basketball (LiveGame.jsx and AdvancedLiveGame.jsx) and football (FootballLiveGame.jsx) stat trackers. End Game sets status to 'final'. 3) Updated EventDetail.jsx to remove bracket tab and related code. Test credentials: antlersportsnetwork@gmail.com / NoahTheJew1997"
