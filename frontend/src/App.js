...
import FootballDemoSelector from "@/pages/FootballDemoSelector";
...
function AppRoutes({ user, onLogin, onLogout }) {
  ...
  return (
    <Routes>
      ...
      <Route path="/demo" element={<DemoSportSelection />} />
      ...
      {/* Account dashboard - requires auth but not sport (for all users) */}
      ...
      <Route path="/baseball/:id/stats" element={<BaseballLiveStats />} />
