...
const modes = [
  {
    ...
    name: "Simple Mode",
    icon: Zap,
    description: "Streamlined interface focused on quick stat entry. Perfect for fast-paced tracking with minimal clicks.",
    features: [
      "Quick rushing/passing buttons",
      "Simplified stats tracking",
      "Faster input workflow",
      "Essential tracking only",
      "Great for youth & recreational games"
    ],
    color: "purple",
    route: "/demo/football/simple"
  },
  {
    id: "advanced",
    name: "Advanced Mode",
    icon: Gauge,
    description: "Full-featured tracking with detailed play-by-play logging, down & distance, and complete analytics.",
    features: [
...
const ModeCard = ({ mode }) => {
  ...
  return (
    <div 
      className={`bg-gray-800 border ${colors.border} rounded-xl overflow-hidden transition-all group`}
      data-testid={`football-mode-card-${mode.id}`}
    >
      {/* Mode Preview */}
      ...
      <div className="p-6">
        ...
        <Button 
          ...
          data-testid={`football-try-${mode.id}-btn`}
        >
          Try {mode.name}
        </Button>
      </div>
...
export default function FootballDemoSelector() {
  return (
          ...
          <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-6 mb-12">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-white font-semibold text-lg">Central Wolves</p>
                  <p className="text-gray-400 text-sm">Home Team • 7 Players</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-white font-semibold text-lg">Riverside Panthers</p>
                  <p className="text-gray-400 text-sm">Away Team • 7 Players</p>
                </div>
              </div>
            </div>
          </div>
