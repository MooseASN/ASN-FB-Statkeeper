...
export default function GameHistory({ user, onLogout }) {
  ...
  const handleDownloadPDF = async (game, e) => {
    ...
    try {
      // Determine the correct PDF endpoint based on sport
      let pdfEndpoint;
      ...
      if (sport === 'baseball') {
        ...
        // Basketball uses the standard boxscore endpoint
      ...
      link.href = url;
      link.setAttribute('download', `${sport}_boxscore_${game.home_team_name}_vs_${game.away_team_name}.pdf`);
