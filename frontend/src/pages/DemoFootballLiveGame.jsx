...
export default function DemoFootballLiveGame() {
  ...
  useEffect(() => {
    const fetchDemoData = async () => {
      try {
        ...
        const res = await axios.get(`${API}/demo/football`, { withCredentials: false });
  ...
  // Render the real FootballLiveGame component with demo mode enabled
  return <FootballLiveGame demoMode={true} initialDemoData={demoData} />;
}
