            ...
            {opponentTeams.length === 0 ? (
              <Card className="bg-slate-800/50 border-slate-700 border-2 border-dashed">
                <CardContent className="p-8 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-white mb-2">No Opponents Added</h3>
                  <p className="text-slate-400 text-sm mb-4 max-w-sm mx-auto">
                    Add opponent teams to schedule games against. You can search for schools on StatMoose or add them manually.
                  </p>
                  {isAdmin && (
